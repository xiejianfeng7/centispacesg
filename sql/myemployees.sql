...
CREATE TABLE `late`  (
  ...
  `count_late` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`employee_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = gb2312 COLLATE = gb2312_chinese_ci ROW_FORMAT = Dynamic;
...
-- Records of late
-- ----------------------------
INSERT INTO `late` VALUES (107, 3);
INSERT INTO `late` VALUES (108, 2);
INSERT INTO `late` VALUES (110, 1);
INSERT INTO `late` VALUES (163, 2);
INSERT INTO `late` VALUES (185, 1);
