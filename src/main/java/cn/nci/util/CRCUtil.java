...
public class CRCUtil {
    ...
    /**
     * CRC-CCITT (XModem) Ascii: 81B4
     * CRC-CCITT (0xFFFF) Ascii: 770C
     * CRC-CCITT (0x1D0F) Ascii: 1E00
     * CRC-CCITT (XModem) Hex: 7C3E
     * CRC-CCITT (0xFFFF) Hex: 9D07
     * CRC-CCITT (0x1D0F) Hex: F8C7
     */
    public static void main(String args[]) {

        String testStr = "ABABABABABABABABABAB";
