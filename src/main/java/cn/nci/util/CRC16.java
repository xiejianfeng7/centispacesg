 ...
 * @description: crc16-ccitt-false加密工具
 * @author: xiejianfeng
 * @create: 2020-09-03 16:47
 */
public class CRC16 {
    /**
...
//    CRC校验结果为 9D07
    public static void main(String[] args) {
        byte [] bytes = new byte []{(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB,(byte) 0xAB};
        int re = crc16(bytes);
